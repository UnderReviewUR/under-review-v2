export function NflPlayerCard({ name, player, onOpen }) {
  return (
    <div className="nfl-player-card" onClick={() => onOpen(name)}>
      ...
      <div className="nfl-player-stats">
        ...
        <div className="nfl-stat">
          ...
          <div className="nfl-stat-value" style={{ color: "var(--nfl)" }}>
            {player.rec2025.td}
          </div>
        </div>
        {player.rec2025.tgt ? (
          ...
          <div className="nfl-stat">
            ...
            <div className="nfl-stat-value">
              {player.rec2025.recPg ?? "—"}
            </div>
          </div>
        )}
        <div className="nfl-stat">
