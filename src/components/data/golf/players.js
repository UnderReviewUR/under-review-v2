...
export const PGA_PLAYERS = {
  ...
  "Nick Dunlap":       { rank:49, country:"USA", age:21, tier:2, sg:{ total:0.52, ott:0.38, app:0.14, arg:0.06, putt:-0.06 }, driving:{ dist:308.2, acc:56.0 }, cutMaking:"71%", top10Rate:"12%", top20Rate:"24%", winRate:"4%", recentForm:["T6","T18","T14","T8","MC","T22"], bestMarkets:["top_20","make_cut","matchup"], note:"2024 Am champ — early PGA profile: solid driver, greens-in-reg growth; SG reflects limited 2025–26 sample vs tour baseline.", comps:["Akshay Bhatia","Ludvig Aberg","Davis Thompson"] },
  "Ryder Schaber":     { rank:72, country:"USA", age:24, tier:2, sg:{ total:0.18, ott:0.22, app:0.04, arg:0.02, putt:-0.10 }, driving:{ dist:299.0, acc:58.5 }, cutMaking:"58%", top10Rate:"4%", top20Rate:"12%", winRate:"0%", recentForm:["T32","MC","T48","MC","T28","T41"], bestMarkets:["make_cut","matchup"], note:"Korn Ferry / Monday-Q path — treat SG as thin-sample; live elevated fields only for matchup punts.", comps:["Hayden Buckley","Andrew Novak","Ben Griffin"] },
  "Jackson Suber":     { rank:95, country:"USA", age:27, tier:2, sg:{ total:0.12, ott:0.16, app:0.02, arg:0.04, putt:-0.10 }, driving:{ dist:296.5, acc:59.2 }, cutMaking:"52%", top10Rate:"2%", top20Rate:"8%", winRate:"0%", recentForm:["MC","T54","MC","T61","MC","T44"], bestMarkets:["matchup"], note:"Fringy tour membership — minimal strokes-gained signal; comp-check vs similar KFT graduates before betting.", comps:["Mark Hubbard","Brendan Steele","Nate Lashley"] },
  "Davis Thompson":    { rank:51, country:"USA", age:25, tier:2, sg:{ total:0.68, ott:0.62, app:0.12, arg:0.02, putt:-0.08 }, driving:{ dist:311.4, acc:55.8 }, cutMaking:"73%", top10Rate:"15%", top20Rate:"28%", winRate:"2%", recentForm:["T8","T14","T22","T11","T31","T18"], bestMarkets:["top_20","make_cut","matchup"], note:"Long driver — 2025–26 SG skewed by boom weeks; watch Bermuda vs poa splits before outrights.", comps:["Cameron Young","Jake Knapp","Ludvig Aberg"] },
  "Michael Thorbjornsen": { rank:54, country:"USA", age:23, tier:2, sg:{ total:0.38, ott:0.28, app:0.12, arg:0.04, putt:-0.06 }, driving:{ dist:305.8, acc:57.2 }, cutMaking:"62%", top10Rate:"8%", top20Rate:"18%", winRate:"1%", recentForm:["T24","T18","MC","T32","T41","T15"], bestMarkets:["top_20","make_cut"], note:"Stanford pedigree — SG still stabilizing across limited 2025–26 PGA cuts; better process than results so far.", comps:["Nick Dunlap","Ludvig Aberg","Garrick Higgo"] },
