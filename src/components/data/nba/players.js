...
// Curated NBA prop profiles.
// Static scouting layer only.
// Live APIs should override current team, availability, and live/stat facts.
...
export const NBA_PLAYERS = {
  ...
  "Luka Doncic": {
    ...
    bettingAngles: [
      ...
      "Assists over when LeBron or AD are limiting his scoring load",
  ...
  "Jayson Tatum": {
    ...
    bettingAngles: [
      ...
      "Back in elimination or must-win spots — elite performer under pressure",
    ],
  ...
  "Anthony Edwards": {
    ...
    bettingAngles: [
      ...
      "Back in rivalry and national TV games — elevates for big moments",
  ...
  "Donovan Mitchell": {
    ...
    bettingAngles: [
      ...
      "Back in national TV and big market games",
      "Fade vs elite perimeter defenders",
    ],
  ...
  "Jaylen Brown": {
    ...
    bettingAngles: [
      ...
      "Back in elimination and playoff games",
  ...
  "OG Anunoby": {
    ...
    bettingAngles: [
      ...
      "Back when Brunson or Towns are drawing attention",
      "Fade pts — fourth scoring option in Knicks system",
    ],
  ...
  "Dejounte Murray": {
    ...
    bettingAngles: [
      ...
      "Back when Zion or Ingram are limited",
    ],
