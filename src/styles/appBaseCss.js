...
export const baseCss = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .docked-bar .ask-wrap--docked-gradient .ur-dock-icon-btn,
  .docked-interaction-zone .ask-wrap--docked-gradient .ur-dock-icon-btn{
    flex-shrink:0;
  }
  ...
  .home-surface-v1 .ask-wrap{margin:12px 0 4px;}
  @media (prefers-reduced-motion:reduce){
  ...
  .home-surface-v1 .ur-home-starter-cards .ask-card-bar{
    display:block;
    width:3px;
    height:28px;
    border-radius:2px;
  ...
  .home-surface-v1 .ur-home-starter-cards .ask-card:hover .ask-card-text{color:#fff;}
  .home-surface-v1 .ur-home-starter-cards .ask-card > div:last-child,
  .home-surface-v1 .ur-home-starter-cards .ur-home-starter-chev{color:rgba(255,255,255,0.35) !important;font-size:17px;flex-shrink:0;line-height:1;}
  .ur-home-promise{
    font-size:17px;
    font-weight:600;
    color:#fff;
  ...
  .ur-wc-home-promo--v2{
    ...
    border-left:2px solid rgba(0,245,233,0.45);
    background:rgba(12,14,18,0.88);
    position:relative;
    overflow:hidden;
  }
  .ur-wc-home-promo-top{
    display:flex;
    align-items:center;
    justify-content:space-between;
    gap:10px;
  ...
  .ur-wc-home-promo-highlights li{margin-bottom:3px;}
  .ur-wc-home-promo-highlights li::marker{color:rgba(0,245,233,0.55);}
  .ur-wc-home-promo-matches{
    display:block;
    width:100%;
    margin:0 0 12px;
    padding:12px 14px;
  ...
  .ur-wc-home-promo-matches:hover{
    border-color:rgba(0,245,233,0.45);
    background:rgba(0,245,233,0.06);
  }
  .ur-wc-home-promo-ask{
    display:flex;
    align-items:center;
    justify-content:space-between;
    gap:10px;
  ...
  .ur-wc-home-promo-ask:hover{
    border-color:rgba(255,255,255,0.14);
    background:rgba(255,255,255,0.06);
  }
  .ur-wc-home-promo-ask-chev{
  ...
  .home-surface-option-a.home-surface-premium.screen.has-msgs{
  ...
  .home-surface-option-a .ur-home-ask-shell{
    max-width:100%;
    margin:0 auto;
  }
  ...
  .ur-home-starters-option-a .ur-home-starters-heading{
    font-family:var(--mono-font);
    font-size:10px;
  ...
  .ur-home-starters-option-a .ur-home-starter-list{
    display:flex;
    flex-direction:column;
    gap:8px;
  }
  .ur-home-starters-option-a .ur-home-starter-item{
    display:flex;
    align-items:center;
    gap:12px;
    width:100%;
  ...
  .ur-home-starters-option-a .ur-home-starter-item:hover{
    border-color:rgba(255,255,255,0.12);
    background:rgba(255,255,255,0.04);
  }
  .ur-home-starters-option-a .ur-home-starter-accent{
    width:3px;
    height:26px;
    border-radius:2px;
    flex-shrink:0;
  ...
  .ur-home-feed:empty{display:none;}
  .ur-home-feed .ur-home-try-row{display:none;}
  .home-surface-option-a .ur-home-last-lean{
    border-color:rgba(255,255,255,0.08);
    background:rgba(255,255,255,0.025);
    box-shadow:none;
  }
  .home-surface-option-a .ur-home-last-lean-label{
    color:rgba(255,255,255,0.38);
  }
  .home-surface-option-a .today-slate-panel,
  .home-surface-option-a .home-ticker-quiet,
  .home-surface-option-a .home-ticker-premium > div,
  .home-surface-option-a .ur-home-live-toggle,
  .home-surface-option-a .spotlight-card{
  ...
  .wc-take-breakdown-body--stacked{display:flex;flex-direction:column;gap:14px;}
  .wc-take-breakdown-block{
    margin:0;
    font-size:14px;
    line-height:1.55;
    color:rgba(255,255,255,0.88);
  }
  .wc-take-slate-match-block{
    display:flex;flex-direction:column;gap:10px;
    margin-top:20px;padding-top:18px;border-top:1px solid var(--border-2);
  }
  .wc-take-slate-match-block:first-of-type{margin-top:2px;padding-top:0;border-top:0;}
  .wc-take-breakdown-section-group{display:flex;flex-direction:column;gap:10px;}
  .wc-take-breakdown-section{margin-top:0;}
  .wc-take-breakdown-section .wc-take-row-label{margin-bottom:6px;}
  .wc-take-breakdown-section--match .wc-take-row-body{
    font-size:14px;font-weight:600;color:var(--text);line-height:1.45;
  }
  .wc-take-breakdown-section--kickoff .wc-take-row-body{
    font-family:var(--mono-font);font-size:12px;color:var(--soft);
  }
  .chat-thread--ur-chat-dock{gap:18px;}
  .chat-thread--ur-chat-dock .ur-imessage-assistant-row{margin-top:4px;}
  .chat-thread--ur-chat-dock .ur-imessage-user-row + .ur-imessage-assistant-row{margin-top:6px;}
  ...
  /* ── World Cup premium theme (cream hero, betting intelligence) ── */
  .wc-screen--premium{
    --wc-premium-bg:#0C0C10;
    --wc-premium-cream:#F3F0E8;
    --wc-premium-ink:#1C1814;
    --wc-premium-accent:#C4A574;
    --wc-premium-accent-dim:rgba(196,165,116,0.35);
    --wc-premium-muted:#8A8478;
  ...
  .app--wc-premium .nav-btn.nav-btn--wc-spotlight{
    color:rgba(196,165,116,0.88);
  }
  .app--wc-premium .nav-btn.nav-btn--wc-spotlight.wc-active{
    color:var(--wc-premium-cream);
    border-color:var(--wc-premium-accent-dim);
    background:rgba(196,165,116,0.1);
  }
  .app--wc-premium .nav-btn.nav-btn--wc-spotlight::after,
  .app--wc-premium .nav-btn.wc-active::after{background:var(--wc-premium-accent);}
  .app--wc-premium .wc-nav-shimmer{
    background:linear-gradient(90deg,#8a7350 0%,#d4c4a8 45%,#f3f0e8 55%,#d4c4a8 100%);
    background-size:200% auto;
    -webkit-background-clip:text;
    background-clip:text;
  }
  ...
  .wc-screen--premium .wc-header-premium__subtitle,
  .wc-screen--premium .wc-subtitle{
    font-size:13px;
    color:var(--wc-premium-muted);
    margin-top:8px;
  }
  ...
  .wc-premium-featured__team:last-child{align-items:center;}
  .wc-premium-featured__flag{
    width:44px;
    height:44px;
    border-radius:50%;
    object-fit:cover;
    border:2px solid rgba(28,24,20,0.08);
  }
  .wc-premium-featured__abbr{
    font-family:var(--mono-font);
    font-size:15px;
    font-weight:700;
    letter-spacing:0.08em;
  ...
  .wc-premium-featured__meta{
    display:flex;
    flex-direction:column;
    gap:6px;
  }
  .wc-premium-featured__meta-item{
    display:flex;
    align-items:flex-start;
    gap:8px;
    font-family:var(--mono-font);
  ...
  .wc-premium-featured__meta-icon{
    flex-shrink:0;
    color:var(--wc-premium-accent);
    opacity:0.85;
  }
  .wc-premium-featured__foot{
    display:flex;
    align-items:flex-start;
    justify-content:space-between;
    gap:14px;
  ...
  .wc-ask-shell--premium .ask-wrap--wc-inline{margin:0;width:100%;}
  .wc-ask-shell--premium .ask-form--wc-inline{width:100%;}
  .wc-ask-shell--premium .ask-wc-inline-hint{
  ...
  .ask-wrap--wc-inline .ask-row--wc-inline{
    display:flex;
    align-items:stretch;
    width:100%;
    min-height:52px;
    border:1px solid var(--wc-premium-accent-dim, rgba(196,165,116,0.35));
    border-radius:14px;
    background:#101014;
    overflow:hidden;
    box-sizing:border-box;
  }
  .ask-wrap--wc-inline .ask-wc-inline-attach{
    display:flex;
    align-items:center;
    justify-content:center;
    width:48px;
  ...
  .ask-wrap--wc-inline .ask-wc-inline-attach.has-img{color:var(--wc-premium-accent,#C4A574);}
  .ask-wrap--wc-inline .ask-bar--wc-inline{
    flex:1;
    min-width:0;
    margin:0;
    ...
    border:none;
    background:transparent;
    color:var(--wc-premium-cream,#F3F0E8);
    font-size:16px;
    line-height:1.35;
    outline:none;
  }
  .ask-wrap--wc-inline .ask-bar--wc-inline::placeholder{color:rgba(243,240,232,0.44);}
  .ask-wrap--wc-inline .ask-wc-inline-send{
    display:flex;
    align-items:center;
    justify-content:center;
    width:52px;
    ...
    background:var(--wc-premium-accent,#C4A574);
    color:var(--wc-premium-ink,#1C1814);
    cursor:pointer;
    padding:0;
    transition:filter 0.15s ease;
  }
  .ask-wrap--wc-inline .ask-wc-inline-send:disabled{
    background:rgba(255,255,255,0.06);
    color:rgba(255,255,255,0.28);
    cursor:not-allowed;
  }
  .ask-wrap--wc-inline .ask-wc-inline-send:not(:disabled):hover{filter:brightness(1.06);}
  .ask-wrap--wc-inline .ask-wc-inline-icon{width:18px;height:18px;}
  .ask-wrap--wc-inline .ask-wc-inline-icon--send{width:16px;height:16px;}
  .ask-form--docked{width:100%;}
  .wc-ask-starters{
    display:flex;
    flex-direction:column;
    gap:8px;
  ...
  .wc-ask-shell--premium .ask-col:focus-within{
    border-color:var(--wc-premium-accent);
  }
  .wc-ask-shell--premium .ask-bar::placeholder{color:rgba(243,240,232,0.42);}
  .wc-ask-shell--premium .send-btn{
    background:var(--wc-premium-accent);
    color:var(--wc-premium-ink);
  }
  ...
  .wc-main-tabs--premium .wc-main-tab{
    flex:1;
    border:none;
    border-radius:0;
    background:transparent;
  ...
  .wc-main-tabs--premium .wc-main-tab--on{
    color:var(--wc-premium-cream);
    border-bottom-color:var(--wc-premium-accent);
    background:transparent;
  }
  .wc-screen--premium .wc-sub-tabs .wc-sub-tab{
    border-color:rgba(196,165,116,0.2);
    background:rgba(255,255,255,0.03);
    color:var(--wc-premium-muted);
  }
  .wc-screen--premium .wc-sub-tabs .wc-sub-tab--on{
    border-color:var(--wc-premium-accent);
    color:var(--wc-premium-accent);
    background:rgba(196,165,116,0.08);
  }
  ...
  .wc-featured-insights__body{
    margin:0 0 10px;
    font-size:13px;
    line-height:1.55;
    color:var(--wc-premium-muted);
  }
  .wc-quick-prompts--premium{display:flex;flex-direction:column;gap:6px;}
  .wc-screen--premium .wc-quick-prompts--premium .quick-btn{
    text-align:left;
    border-color:rgba(196,165,116,0.22);
    background:rgba(196,165,116,0.06);
    color:var(--wc-premium-cream);
  }
  .wc-screen--premium .wc-match-card{
    background:rgba(255,255,255,0.03);
    border-color:rgba(196,165,116,0.14);
  }
  .wc-screen--premium .wc-strength--favorite{
    color:var(--wc-premium-accent);
    border-color:var(--wc-premium-accent-dim);
  }
  ...
  .wc-match-read{
    ...
    border:1px solid rgba(0,229,255,0.22);background:rgba(0,229,255,0.04);
  }
  .wc-match-read--live{border-color:rgba(239,68,68,0.35);background:rgba(239,68,68,0.06);}
  .wc-match-read--compact{padding:8px 10px;margin:8px 0 6px;}
  .wc-match-read__head{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:6px;}
  .wc-match-read__badge{
    font-family:var(--mono-font);font-size:9px;letter-spacing:0.12em;text-transform:uppercase;
    color:var(--wc-premium-accent, #00e5ff);
  }
  .wc-match-read--live .wc-match-read__badge{color:#f87171;}
  .wc-match-read__xi{font-size:9px;color:var(--muted);font-family:var(--mono-font);}
  .wc-match-read__headline{
    margin:0 0 6px;font-size:14px;font-weight:600;line-height:1.35;color:var(--text);
  }
  .wc-match-read--compact .wc-match-read__headline{font-size:13px;margin-bottom:4px;}
  .wc-match-read__subline{margin:0 0 8px;font-size:11px;line-height:1.4;color:var(--muted);}
  .wc-match-read__bar-block{margin:6px 0 8px;}
  .wc-match-read__bar-label{
    margin:0 0 4px;font-size:9px;text-transform:uppercase;letter-spacing:0.08em;color:var(--muted);
  }
  .wc-match-read__edge-chip{
    display:inline-flex;margin:6px 0 8px;padding:5px 10px;border-radius:999px;
    border:1px solid rgba(250,204,21,0.35);background:rgba(250,204,21,0.08);
    max-width:100%;
  }
  .wc-match-read__edge-label{font-size:11px;font-weight:600;color:#fde68a;line-height:1.3;}
  .wc-match-read__momentum{margin:8px 0;}
  .wc-match-read__momentum-row{display:grid;grid-template-columns:36px 1fr 44px;gap:8px;align-items:center;margin-bottom:6px;}
  .wc-match-read__momentum-abbr{font-family:var(--mono-font);font-size:10px;color:var(--soft);}
  .wc-match-read__momentum-track{height:6px;border-radius:999px;background:rgba(255,255,255,0.08);overflow:hidden;}
  .wc-match-read__momentum-fill{display:block;height:100%;border-radius:999px;}
  .wc-match-read__momentum-fill--home{background:var(--wc-blue);}
  .wc-match-read__momentum-fill--away{background:var(--wc-gold);}
  .wc-match-read__momentum-val{font-family:var(--mono-font);font-size:10px;color:var(--muted);text-align:right;}
  .wc-match-read__players{list-style:none;margin:8px 0 0;padding:0;}
  .wc-match-read__players li{display:flex;justify-content:space-between;gap:8px;font-size:11px;color:var(--soft);padding:3px 0;}
  .wc-match-read__deeper-btn{
    margin-top:8px;padding:7px 12px;border-radius:8px;border:1px solid rgba(0,229,255,0.35);
    background:transparent;color:var(--wc-premium-accent, #00e5ff);font-size:12px;font-weight:600;
    cursor:pointer;width:100%;text-align:center;font-family:inherit;
  }
  .wc-match-read__deeper-btn--full{margin-top:12px;}
  .wc-edge-strip{
    margin:0 0 12px;padding:10px 12px;border-radius:12px;border:1px solid var(--border);
    background:rgba(255,255,255,0.02);
  }
  .wc-edge-strip__head{display:flex;align-items:baseline;justify-content:space-between;gap:8px;margin-bottom:8px;}
  .wc-edge-strip__title{font-size:11px;font-weight:700;letter-spacing:0.06em;text-transform:uppercase;color:var(--soft);}
  .wc-edge-strip__hint{font-size:10px;color:var(--muted);font-family:var(--mono-font);}
  .wc-edge-strip__chips{display:flex;flex-wrap:wrap;gap:8px;}
  .wc-edge-strip__chip{
    padding:6px 10px;border-radius:999px;border:1px solid rgba(250,204,21,0.3);
    background:rgba(250,204,21,0.07);color:#fde68a;font-size:11px;font-weight:600;cursor:pointer;
    font-family:inherit;
  }
  ...
  .wc-detail-drawer{
    width:min(480px,100%);max-height:min(85dvh, calc(100% - 32px));overflow-y:auto;
  ...
  .wc-detail-team-col{display:flex;flex-direction:column;align-items:center;gap:6px;font-size:13px;font-weight:600;text-align:center;flex:1;}
  .wc-detail-team-vs{font-size:11px;color:var(--muted);flex-shrink:0;}
  .wc-detail-venue{font-size:12px;color:var(--muted);text-align:center;margin:0 0 12px;}
  .wc-detail-model-odds{margin:0 0 12px;}
  .wc-detail-model-odds__label{font-size:10px;text-transform:uppercase;letter-spacing:0.08em;color:var(--muted);margin:0 0 6px;}
  .wc-detail-group-roster{margin:14px 0;}
  .wc-detail-group-roster h4{margin:0 0 8px;font-size:12px;text-transform:uppercase;letter-spacing:0.08em;color:var(--muted);}
  .wc-detail-group-roster ul{list-style:none;margin:0;padding:0;}
  .wc-detail-group-roster li{display:flex;justify-content:space-between;gap:8px;font-size:13px;padding:5px 0;border-bottom:1px solid var(--border);}
  .wc-detail-group-roster li:last-child{border-bottom:none;}
  .wc-detail-tier{font-size:11px;color:var(--wc-gold);}
  .wc-detail-xi-note{font-size:12px;line-height:1.45;color:var(--soft);margin:12px 0 8px;}
  .wc-detail-live-note{margin-bottom:12px;}
  .wc-detail-ask-btn{width:100%;margin-top:8px;}
  ...
  .wc-named-leg-citation{
    margin:0 0 12px;padding:10px 16px 0;
    border-bottom:1px solid rgba(255,255,255,.06);
    padding-bottom:12px;
  }
  .wc-named-leg-citation-line{
    margin:0 0 6px;
    font-family:var(--mono-font);
    font-size:11px;
    line-height:1.45;
  ...
  .wc-named-leg-citation-line:last-child{margin-bottom:0;}
  .wc-named-leg-citation-line--player{color:rgba(180,220,255,.92);}
  .wc-named-leg-citation-line--legid{color:rgba(0,245,233,.78);font-size:10px;}
  .wc-named-leg-citation-line--note{color:rgba(255,200,120,.78);}
  .wc-take-headline{
    font-family:var(--display-font);font-size:15px;font-weight:600;line-height:1.35;
  ...
  .wc-take-slate-match-block:first-of-type{margin-top:0;padding-top:0;border-top:0;}
  .wc-take-breakdown-section-group{display:flex;flex-direction:column;gap:10px;}
  .wc-take-breakdown-section--match:first-of-type{margin-top:0;padding-top:0;border-top:0;}
  .wc-take-breakdown-section .wc-take-row-label{margin-bottom:6px;}
  .wc-take-breakdown-section .wc-take-row-body{font-size:13px;line-height:1.55;}
  .wc-take-footer{
