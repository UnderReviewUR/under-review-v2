...
export function buildWcHomePromoCard(nowMs = Date.now()) {
  ...
  return {
    ...
    tagline: "June 11 – July 19 · 104 matches",
    trustLine: "Lines may shift after Starting XIs.",
    featureLine: "Odds, movement, and sharp splits on every match.",
    matchesCta: "Today's matches",
    highlights: [
