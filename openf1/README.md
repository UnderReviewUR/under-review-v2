...
### Deploying for UnderReview

If you host this stack for the UnderReview product (custom OpenF1 URL + optional shared secret with Vercel), see **[UNDERREVIEW.md](UNDERREVIEW.md)** for endpoints, env vars, and Docker notes.
