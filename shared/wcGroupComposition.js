...
export function shouldUseWcCrossGroupValuePrebuilt(question, wcIntent) {
  ...
  if (isWcKnockoutSlateQuestion(routingQ)) return false;
...
export function buildWcCrossGroupValuePrebuiltStructured(opts = {}) {
  ...
  return attachWcMispriceAuditFootnote(
    ...
    },
    {
      ...
      formFixturesResolved: opts.formFixturesResolved,
      formRatingRange: opts.formRatingRange,
      formBumpApplied: opts.formBumpApplied,
      bdlFutures: opts.bdlFutures,
      bdlMarketType: bdlType,
