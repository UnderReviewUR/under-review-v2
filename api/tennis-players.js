...
Mboko: {
        ...
        rallyProfile: { short: { pct: 33, winPct: 54 }, medium: { pct: 37, winPct: 52 }, long: { pct: 30, winPct: 50 }, profile: "20-year-old rising fast. Elo rank 6. 7.1% DF rate and 37.5% tiebreak rate are the current limiting factors.", bettingAngle: "Back on hard courts — 16-5 in 2026 is legitimate. Fade in tiebreaks (37.5% alarming)." }
      },
      Anisimova: {
        eloRank: 7, elo: 2050,
        ...
        rallyProfile: { short: { pct: 34, winPct: 54 }, medium: { pct: 36, winPct: 53 }, long: { pct: 30, winPct: 51 }, profile: "Aggressive flat hitter. DF rate (5.9%) is the risk.", bettingAngle: "Dangerous on hard courts. DF props are live. Back when hitting her spots." }
      },
      Svitolina: {
        eloRank: 8, elo: 2049,
        ...
        rallyProfile: { short: { pct: 26, winPct: 50 }, medium: { pct: 36, winPct: 54 }, long: { pct: 38, winPct: 57 }, profile: "Counter-punching defensive baseliner. Long-rally win rate (57%) elite — gets stronger as matches grind.", bettingAngle: "Best WTA long-match lean. yElo #4 in 2026 massively underrated by the market." }
      },
      Muchova: {
        eloRank: 9, elo: 2041,
      ...
      "Diana Shnaider": {
        ...
        rallyProfile: { short: { pct: 32, winPct: 53 }, medium: { pct: 37, winPct: 54 }, long: { pct: 31, winPct: 53 }, profile: "Aggressive baseliner with elite tiebreak rate (77.8%). All rally bands positive.", bettingAngle: "Back in tiebreak-heavy matchups — 77.8% tiebreak rate is elite." }
      },
      "Anna Kalinskaya": {
        ...
        rallyProfile: { short: { pct: 31, winPct: 52 }, medium: { pct: 38, winPct: 54 }, long: { pct: 31, winPct: 53 }, profile: "Return-heavy player. 42.7% break rate is elite.", bettingAngle: "Back vs serve-first players who can't sustain rallies. Hard court dominance (24-13) reliable." }
      },
      "Jelena Ostapenko": {
        ...
        rallyProfile: { short: { pct: 40, winPct: 58 }, medium: { pct: 35, winPct: 51 }, long: { pct: 25, winPct: 43 }, profile: "Feast-or-famine flat hitter. Long-rally rate (43%) worst in WTA top 20.", bettingAngle: "Vs clay grinders is terrible for her. Against big servers on fast hard she can explode. DF props almost always live." }
      },
      "Mirra Andreeva": {
        ...
        rallyProfile: { short: { pct: 28, winPct: 51 }, medium: { pct: 36, winPct: 53 }, long: { pct: 36, winPct: 55 }, profile: "Young baseliner whose long-rally game (55%) is already her primary weapon. 51.6% break rate elite.", bettingAngle: "Back in slow conditions and long matches. Profile improves with age." }
      },
      "Beatriz Haddad Maia": {
        ...
        rallyProfile: { short: { pct: 29, winPct: 51 }, medium: { pct: 37, winPct: 53 }, long: { pct: 34, winPct: 55 }, profile: "Aggressive clay baseliner who improves in longer rallies. 47.3% break rate and 72.7% tiebreak rate strong.", bettingAngle: "Reliable lean on clay in grinding matches. Fade on fast surfaces." }
      },
      "Marta Kostyuk": {
        ...
        rallyProfile: { short: { pct: 29, winPct: 51 }, medium: { pct: 37, winPct: 53 }, long: { pct: 34, winPct: 54 }, profile: "Return-heavy baseliner with elite break conversion (46.3%). Hard court dominant.", bettingAngle: "Back on hard courts — 26-12 record and DR 1.29 are legitimate." }
      },
      "Donna Vekic": {
        ...
        rallyProfile: { short: { pct: 33, winPct: 53 }, medium: { pct: 38, winPct: 54 }, long: { pct: 29, winPct: 52 }, profile: "Consistent all-court player with no obvious rally weakness. Grass is her best surface.", bettingAngle: "Underrated on grass — 11-4 record is legitimate." }
      },
      "Victoria Azarenka": {
      ...
      "Madison Keys": {
        ...
        rallyProfile: { short: { pct: 37, winPct: 57 }, medium: { pct: 36, winPct: 54 }, long: { pct: 27, winPct: 50 }, profile: "Power hitter with short-point lean. DR 1.35 strong overall.", bettingAngle: "Dangerous in best-of-3 on any surface in current form. Over aces and under total games on fast courts." }
      },
      "Emma Navarro": {
      ...
      "Magdalena Frech": {
        ...
        rallyProfile: { short: { pct: 29, winPct: 51 }, medium: { pct: 38, winPct: 53 }, long: { pct: 33, winPct: 53 }, profile: "Return-first baseliner with 40.6% break rate. Hold rate (52.9%) is low.", bettingAngle: "Target opponent break props vs Frech — her 52.9% hold rate is exploitable." }
      },
      "Linda Noskova": {
      ...
      "Liudmila Samsonova": {
        ...
        rallyProfile: { short: { pct: 35, winPct: 54 }, medium: { pct: 37, winPct: 53 }, long: { pct: 28, winPct: 50 }, profile: "Aggressive flat hitter. Short and medium rallies her domain. Long-rally rate (50%) coin-flip.", bettingAngle: "Back on fast hard in best-of-3. Fade in long grinding matches." }
      },
      ...
      "Yulia Putintseva": {
        ...
        rallyProfile: { short: { pct: 27, winPct: 50 }, medium: { pct: 37, winPct: 53 }, long: { pct: 36, winPct: 55 }, profile: "Return-heavy grinder. 51.5% break rate one of the best on tour. Grass record (8-1) is the hidden gem.", bettingAngle: "Back on grass — 88.9% win rate is extraordinary." }
      },
      ...
      "Leylah Fernandez": {
        ...
        rallyProfile: { short: { pct: 28, winPct: 51 }, medium: { pct: 37, winPct: 53 }, long: { pct: 35, winPct: 54 }, profile: "Aggressive counter-puncher with strong grass credentials. Break rate (44.8%) is her weapon.", bettingAngle: "Back on grass — 7-3 record is legit. Fade as a favorite on hard courts." }
      },
      "Elise Mertens": {
        ...
        rallyProfile: { short: { pct: 29, winPct: 51 }, medium: { pct: 37, winPct: 53 }, long: { pct: 34, winPct: 54 }, profile: "Defensive baseliner with strong break conversion (45.2%) and weak hold rate (53.8%).", bettingAngle: "Target break point props when she has a return-game mismatch. Fade in tiebreaks (25%)." }
      },
      "Anastasia Potapova": {
      ...
      "Petra Kvitova": {
        ...
        rallyProfile: { short: { pct: 38, winPct: 57 }, medium: { pct: 35, winPct: 52 }, long: { pct: 27, winPct: 47 }, profile: "Left-handed power server. Short-point dominance built on flat serve and forehand. Grass is her best surface.", bettingAngle: "Still dangerous on grass. Fade on clay and in long physical matches." }
      },
      "Barbora Vondrousova": {
        ...
        rallyProfile: { short: { pct: 27, winPct: 50 }, medium: { pct: 37, winPct: 53 }, long: { pct: 36, winPct: 55 }, profile: "Creative left-handed baseliner. Long-rally win rate (55%) is her strength. Wimbledon champion 2023.", bettingAngle: "Back in slow conditions and grinding matches. Fade on fast hard courts." }
      },
      "Sorana Cirstea": {
        ...
        rallyProfile: { short: { pct: 33, winPct: 52 }, medium: { pct: 37, winPct: 53 }, long: { pct: 30, winPct: 51 }, profile: "Solid baseliner with no dominant rally length. All bands hover near 51-53%.", bettingAngle: "Reliable underdog value play in best-of-3." }
      },
      "Daria Kasatkina": {
        eloRank: 9, elo: 0,
        record: "42-23",
        ...
        rallyProfile: { short: { pct: 28, winPct: 51 }, medium: { pct: 37, winPct: 54 }, long: { pct: 35, winPct: 55 }, profile: "Smart baseliner who improves as rallies develop.", bettingAngle: "Back in grinding conditions and on clay." }
      },
      "Linda Fruhvirtova": {
      ...
      "Marie Bouzkova": {
        ...
        rallyProfile: { short: { pct: 29, winPct: 50 }, medium: { pct: 37, winPct: 53 }, long: { pct: 34, winPct: 54 }, profile: "Defensive baseliner with strong break rate (44.5%) and weak tiebreak rate (36.4%).", bettingAngle: "Fade in tiebreaks — 36.4% is well below average." }
      },
      "Katerina Siniakova": {
      ...
      "Clara Tauson": {
        ...
        rallyProfile: { short: { pct: 30, winPct: 51 }, medium: { pct: 37, winPct: 52 }, long: { pct: 33, winPct: 51 }, profile: "Aggressive baseliner with 49.4% break rate and very poor tiebreak rate (28.6%).", bettingAngle: "Tiebreak fade is automatic — 28.6% is well below average." }
      },
      "Viktoriya Tomova": {
      ...
      "Jessica Bouzas Maneiro": {
        ...
        rallyProfile: { short: { pct: 28, winPct: 49 }, medium: { pct: 36, winPct: 52 }, long: { pct: 36, winPct: 53 }, profile: "Baseline grinder with critically low hold rate (47.4%) but strong tiebreak rate (66.7%).", bettingAngle: "Tiebreak rate (66.7%) is her one genuine edge. Fade in service hold props." }
      },
      "Anhelina Kalinina": {
      ...
      "Naomi Osaka": {
        ...
        rallyProfile: { short: { pct: 37, winPct: 55 }, medium: { pct: 36, winPct: 53 }, long: { pct: 27, winPct: 48 }, profile: "Serve-reliant power player. Tiebreak rate (38.5%) extremely low.", bettingAngle: "Fade in tiebreaks — 38.5% one of the worst rates on tour." }
      },
      "Katie Volynets": {
      ...
      "Lucia Bronzetti": {
        ...
        rallyProfile: { short: { pct: 28, winPct: 50 }, medium: { pct: 37, winPct: 53 }, long: { pct: 35, winPct: 54 }, profile: "Defensive Italian baseliner. 43.7% break conversion solid. Short-point rate (50%) coin-flip.", bettingAngle: "Back at +150 or better on clay. Fade as a favorite on hard courts." }
      },
      "Katie Boulter": {
